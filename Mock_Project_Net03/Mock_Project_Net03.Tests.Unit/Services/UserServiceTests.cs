...
//        {
//            _sut = new UserService(_userRepo, _mapper, _userRoleRepo);
//        }
...
//            _userRepo.Update(Arg.Any<User>()).Returns(updatedUserEntity);
//            _userRepo.Commit().Returns(1);
//            var expect = userUpdate;

//            var result = await _sut.ChangeUserRole(userUpdate, userRole.RoleId);
...
//            Func<Task> action = async () => await _sut.ChangeUserRole(updateUserRoleModel, roleId);
